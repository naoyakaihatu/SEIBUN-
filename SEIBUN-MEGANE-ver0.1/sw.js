const CACHE='seibun-megane-01-20260913';
const CORE=['./','./index.html','./styles.css','./data/config.js','./data/diagnosis.js','./data/ingredients.js','./js/core.js','./js/ingredients.js','./js/diagnosis.js','./js/ocr.js','./js/app.js'];
